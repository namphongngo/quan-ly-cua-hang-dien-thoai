...
public class BillDAOImpl implements BillDAO {
    ...
    @Override
    public void deleteById(Long id) {XJdbc.executeUpdate(DELETE_SQL, id);}
    @Override
    public List<Bill> findAll() {return XQuery.getBeanList(Bill.class, FIND_ALL_SQL);}
    @Override
    public Bill findById(Long id) {return XQuery.getSingleBean(Bill.class, FIND_BY_ID_SQL, id);}    
    @Override
    public List<Bill> findByUsername(String username) {return XQuery.getBeanList(Bill.class, FIND_BY_USERNAME_SQL, username);}
    @Override
    public List<Bill> findByCardId(Integer cardId) {return XQuery.getBeanList(Bill.class, FIND_BY_CARDID_SQL, cardId);}
    @Override
    public List<Bill> findByTimeRange (Date begin, Date end) {return XQuery.getBeanList(Bill.class, FIND_BY_TIMERANGE_SQL, begin, end);}
    @Override
